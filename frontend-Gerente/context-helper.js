...
function irParaProduto(produtoId) {
  if (ehGerente()) {
    window.location.href = `${HOST_BACKEND}/frontend-Gerente/produtoGerente/produtoGerente.html?id=${produtoId}`;
  } else {
...
function irParaCarrinho() {
  if (ehGerente()) {
    window.location.href = `${HOST_BACKEND}/frontend-Gerente/carrinhoGerente/carrinhoGerente.html`;
  } else {
...
function irParaPedidos() {
  if (ehGerente()) {
    window.location.href = `${HOST_BACKEND}/frontend-Gerente/carrinhoGerente/registroPedidosGerente.html`;
  } else {
